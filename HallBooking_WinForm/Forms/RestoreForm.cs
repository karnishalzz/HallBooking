...
namespace HallBooking_WinForm.Forms
{
    public partial class RestoreForm : Form
    {
            ...
            try
            {
                if (!string.IsNullOrEmpty(directorytextBox.Text))
                {
                    using (var con = new SqlConnection())
                    {
                        ...
                        con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\HallDatabase.mdf;Integrated Security=True;";
                        con.Open();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            diag.Filter = "Database file (HallDatabase.bak)|HallDatabase.bak";
